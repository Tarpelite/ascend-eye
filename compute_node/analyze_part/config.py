...
class VideoConfig:
    ...
    ANALYSIS_INTERVAL = 4  # 分析间隔(秒)
    BUFFER_DURATION = 4  # 滑窗分析时长（实际模型分析视频时长）#强制抽帧，每秒一帧率
...
class APIConfig:
    # 通义千问API配置
    QWEN_API_KEY = "sk-f0e683a01d464b0bb790f34524463fc5"
    ...
    MOONSHOT_API_KEY = "sk-044f6ffb142f4470a11610e243920758"
    MOONSHOT_API_URL = "https://api.deepseek.com/v1"
    MOONSHOT_MODEL = "deepseek-chat"
